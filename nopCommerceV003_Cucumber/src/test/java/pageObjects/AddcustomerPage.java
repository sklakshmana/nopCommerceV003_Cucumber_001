...
public class AddcustomerPage {
	...
	By lstitemAdministrators=By.xpath("//li[@class='k-item k-state-hover']");
	By lstitemRegistered=By.xpath("//li[@class='k-item k-state-hover']");
	By lstitemGuests=By.xpath("//li[@class='k-item k-state-hover']");
	By lstitemVendors=By.xpath(" //li[@class='k-item k-state-hover']");
